...
<head>
<meta charset="utf-8">
<title>Maisjesan-弥芮萨 管理中心</title>
...
<div class="loginTop" <?php echo GetLoginBg(); ?>>
	<div class="logo"><a href="/MyWind" target="_blank"></a></div>
	<div class="text"><span class="note">
		<?php if(strstr(GetCurUrl(), '/admin/login')) echo '提示：您的后台路径为/<i>admin</i>/，建议更改为更加安全的路径！'; ?>
		</span>
		<?php /*?><?php if($cfg_author != '') echo '<i>Author : '.$cfg_author.'</i><span class="line">|</span>'; ?>
		访问 <i><a href="http://phpmywind.com/" target="_blank" class="link">phpMyWind.com</a></i><span class="line">|</span><a href="http://phpmywind.com/bbs/" target="_blank">帮助</a><?php */?></div>
</div>
<div class="loginWarp">
	<div class="loginArea">
