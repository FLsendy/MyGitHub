		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="shoppingcart">
			...
			<tr>
				<td height="60" colspan="2" align="right" valign="bottom">
					<strong class="total">总计：</strong><span class="totalprice"><?php echo $totalprice + $postprice; ?>元</span>（包含运费：<?php echo $postprice; ?>元）<a href="history.go(-1);" class="next">上一步</a><a href="javascript:;" onclick="form.submit();" class="next">提　交</a></td>
			</tr>
		</table>
