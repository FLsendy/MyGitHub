...
<body>
<div class="gray_header"> <span class="title">添加图片信息</span> <span class="reload"><a href="javascript:location.reload();">刷新</a></span> </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		...
		<tr>
			...
			<td><input type="text" name="orderid" id="orderid" class="input_short" value="<?php echo GetOrderID('#@__infoimg'); ?>" /></td>
		</tr>
		<tr>
