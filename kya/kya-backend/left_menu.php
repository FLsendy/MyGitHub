...
<div id="scrollmenu">
	...
	<div class="viewport">
		<div class="overview"> 
			<!--scrollbar start-->
			<div class="menubox">
				<div class="title ton" id="t1" onclick="DisplayMenu('leftmenu01');" title="点击切换显示或隐藏"> 网站系统管理 </div>
			...
			<div class="menubox">
				...
				<div id="leftmenu02" style="display:none"> <a href="infoclass.php" target="main">栏目管理</a> <a href="maintype.php" target="main">二级类别管理</a>
					...
					<div class="hr_1"> </div>
					<a href="fragment.php" target="main">碎片数据管理</a> <a href="diymenu.php" target="main">自定义菜单项</a> <a href="diymodel.php" target="main">自定义模型</a> <a href="diyfield.php" target="main">自定义字段</a> <a href="infoflag.php" target="main" title="信息标记管理" class="infoattr"></a> <a href="infosrc.php" target="main" title="信息来源管理" class="infosrc"></a> </div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
			...
			<div class="menubox">
				...
				<div id="leftmenu05" style="display:none;"> <a href="nav.php" target="main">导航菜单设置</a> <a href="editfile.php" target="main">默认模板管理</a>
					<div class="hr_1"> </div>
